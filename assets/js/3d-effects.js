...
(function () {
    ...
    function initFloatingOrbs() {
        ...
        const orbConfigs = [
            { size: 400, x: '10%', y: '15%', color: 'rgba(77, 142, 255, 0.04)', dur: 18, delay: 0 },
            { size: 300, x: '75%', y: '25%', color: 'rgba(167, 139, 250, 0.03)', dur: 22, delay: -5 },
            { size: 350, x: '50%', y: '60%', color: 'rgba(110, 180, 255, 0.025)', dur: 25, delay: -10 },
            { size: 250, x: '20%', y: '80%', color: 'rgba(167, 139, 250, 0.03)', dur: 20, delay: -8 },
            { size: 200, x: '85%', y: '70%', color: 'rgba(77, 142, 255, 0.035)', dur: 15, delay: -3 },
        ];
    ...
    function initSectionEntrance() {
        ...
        document.querySelectorAll('.section').forEach(section => {
            ...
            section.style.transition = 'all 1.4s cubic-bezier(0.16,1,0.3,1)';
